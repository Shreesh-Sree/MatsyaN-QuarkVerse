...
import { ArrowRight, MapPin, CloudSun, Shield, Scale, MessageCircle, LifeBuoy, Bot, Users, Zap, Star, CheckCircle, Globe } from "lucide-react";
  ...
  const features = [
    {
      ...
      icon: MapPin,
      href: "/map",
      color: "from-google-blue to-google-green",
    ...
    },
    {
      ...
      icon: CloudSun,
      href: "/dashboard",
      color: "from-android-green to-google-green",
      bgColor: "bg-android-green/10"
    },
    {
      title: "Fishing Laws",
    ...
    },
    {
      ...
      icon: Shield,
      href: "/safety",
      color: "from-firebase-red to-firebase-orange",
      bgColor: "bg-firebase-red/10"
    },
    {
      title: "AI Assistant",
      ...
      icon: MessageCircle,
      href: "/chat",
      color: "from-gemini-pink to-google-blue",
      bgColor: "bg-gemini-pink/10"
    },
    {
        title: "Universal Translator",
        description: "Translate any text into 50+ languages for global fishing communities.",
        icon: Globe,
        href: "/translate",
        color: "from-google-blue to-gemini-pink",
        bgColor: "bg-google-blue/10"
    }
  ];
      ...
      <main className="flex-1">
        ...
        <section className="relative py-24 lg:py-32 px-4 md:px-8 text-center">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-google-blue/10 border border-google-blue/20 text-google-blue text-sm font-medium mb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
                <Link href={user ? "/dashboard" : "/login"}>
                    <Button size="lg" className="gap-3 px-10 py-7 text-lg font-semibold bg-google-blue hover:bg-google-blue/90 text-white rounded-xl transition-colors duration-200">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20">
              {stats.map((stat, index) => (
                <div key={stat.label} className="text-center">
                  <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-google-blue/10 mx-auto mb-3">
        ...
        <section className="py-24 px-4 md:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
                <span className="text-google-blue font-semibold text-sm uppercase tracking-wider">Our Features</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
              {features.map((feature) => (
                <Link
                  key={feature.title}
                  href={feature.href}
                  className="group bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 hover:border-google-blue/30 dark:hover:border-google-blue/60 transition-colors duration-200"
                >
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-6`}>
                    <feature.icon className="w-7 h-7 text-white" />
                  </div>
                  <h3 className="text-xl font-semibold text-foreground mb-4 group-hover:text-google-blue transition-colors duration-200">
                    {feature.title}
                  </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
                  <div className="w-14 h-14 bg-google-blue/10 dark:bg-google-blue/20 rounded-2xl flex items-center justify-center mb-6">
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
                  <div className="w-14 h-14 bg-android-green/10 dark:bg-android-green/20 rounded-2xl flex items-center justify-center mb-6">
                    <CloudSun className="w-6 h-6 text-android-green" />
                  </div>
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
                  <div className="w-14 h-14 bg-firebase-red/10 dark:bg-firebase-red/20 rounded-2xl flex items-center justify-center mb-6">
                    <Shield className="w-6 h-6 text-firebase-red" />
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
                  <div className="w-14 h-14 bg-gemini-pink/10 dark:bg-gemini-pink/20 rounded-2xl flex items-center justify-center mb-6">
                    <Globe className="w-6 h-6 text-gemini-pink" />
                  </div>
                  <h3 className="text-lg font-semibold text-foreground mb-3">Global Communication</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed">Translate any text into 50+ languages to connect with fishing communities worldwide.</p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-center gap-3 p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
                    <CheckCircle className="w-5 h-5 text-google-green flex-shrink-0" />
